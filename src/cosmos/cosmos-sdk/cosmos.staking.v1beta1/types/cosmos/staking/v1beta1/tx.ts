...
export const MsgCreateValidator = {
  ...
  fromJSON(object: any): MsgCreateValidator {
    ...
    if (
      object.commission !== undefined &&
      object.commission !== null
    ) {
      message.commission = CommissionRates.fromJSON(
        object.commission
      );
    } else {
    ...
    if (
      ...
      message.min_self_delegation = String(
        object.min_self_delegation
      );
    } else {
  ...
  fromPartial(
    object: DeepPartial<MsgCreateValidator>
  ): MsgCreateValidator {
    const message = {
      ...baseMsgCreateValidator,
    } as MsgCreateValidator;
    if (
      ...
      message.description = Description.fromPartial(
        object.description
      );
    } else {
      message.description = undefined;
    ...
    if (
      ...
      message.commission = CommissionRates.fromPartial(
        object.commission
      );
    } else {
      message.commission = undefined;
...
export const MsgEditValidator = {
  ...
  fromPartial(
    object: DeepPartial<MsgEditValidator>
  ): MsgEditValidator {
    const message = { ...baseMsgEditValidator } as MsgEditValidator;
    if (
      object.description !== undefined &&
...
export const MsgDelegateResponse = {
  ...
  fromPartial(
    _: DeepPartial<MsgDelegateResponse>
  ): MsgDelegateResponse {
    const message = {
      ...baseMsgDelegateResponse,
    } as MsgDelegateResponse;
...
export const MsgBeginRedelegate = {
  ...
  fromJSON(object: any): MsgBeginRedelegate {
    ...
    if (
      ...
      message.validator_src_address = String(
        object.validator_src_address
      );
    } else {
    ...
    if (
      ...
      message.validator_dst_address = String(
        object.validator_dst_address
      );
    } else {
  ...
  fromPartial(
    object: DeepPartial<MsgBeginRedelegate>
  ): MsgBeginRedelegate {
    const message = {
      ...baseMsgBeginRedelegate,
    } as MsgBeginRedelegate;
...
export const MsgBeginRedelegateResponse = {
  ...
  fromJSON(object: any): MsgBeginRedelegateResponse {
    ...
    if (
      ...
      message.completion_time = fromJsonTimestamp(

...
export const MsgSend = {
  ...
  fromJSON(object: any): MsgSend {
    ...
    message.amount = [];
    if (
      object.from_address !== undefined &&
      object.from_address !== null
    ) {
    ...
    if (
      object.to_address !== undefined &&
      object.to_address !== null
    ) {
...
export const MsgMultiSendResponse = {
  ...
  fromPartial(
    _: DeepPartial<MsgMultiSendResponse>
  ): MsgMultiSendResponse {
    const message = {
      ...baseMsgMultiSendResponse,
    } as MsgMultiSendResponse;
...
export class MsgClientImpl implements Msg {
  ...
  Send(request: MsgSend): Promise<MsgSendResponse> {
    ...
    return promise.then((data) =>
      MsgSendResponse.decode(new Reader(data))
    );
  }

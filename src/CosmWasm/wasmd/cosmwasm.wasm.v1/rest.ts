...
> extends HttpClient<SecurityDataType> {
  ...
  querySmartContractState = <T, U>(
    ...
    return this.request<V1QuerySmartContractStateResponse, RpcStatus>({
      path: `/cosmwasm/wasm/v1/contract/${address}/smart/${query}`,
      method: "GET",
      format: "json",
      ...params,
    }).then((resp) => resp.data.data && castFn(resp.data.data));
  };

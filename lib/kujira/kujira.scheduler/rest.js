...
export class Api extends HttpClient {
    constructor() {
         ...
         * @request GET:/kujira/scheduler/hook
         */
        this.queryHookAll = (query, params = {}) => this.request(Object.assign({ path: `/kujira/scheduler/hook`, method: "GET", query: query, format: "json" }, params));
        /**
         * No description
         *
         * @tags Query
         ...
         * @request GET:/kujira/scheduler/hook/{id}
         */
        this.queryHook = (id, params = {}) => this.request(Object.assign({ path: `/kujira/scheduler/hook/${id}`, method: "GET", format: "json" }, params));
        /**
         * No description
         *
         * @tags Query
         ...
         * @request GET:/kujira/scheduler/params
         */
        this.queryParams = (params = {}) => this.request(Object.assign({ path: `/kujira/scheduler/params`, method: "GET", format: "json" }, params));
    }
}

...
const getAccounts = (client, session) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const accountData = Object.assign(Object.assign({}, data), { pubkey: buffer_1.Buffer.from(data.pubkey, "base64") });
    return [accountData];
});
                ...
                request: {
                    ...
                    params: {
                        ...
                        msgs: msgs
                            ...
                            .map((x) => (Object.assign(Object.assign({}, x), { value: buffer_1.Buffer.from(x.value).toString("base64") }))),
                    },
                },
            });
            const client = yield stargate_1.StargateClient.connect(rpc);
            const res = yield client.broadcastTx(buffer_1.Buffer.from(bytes, "base64"));

...
function signAndBroadcast({ rpc, signer, messages, sourceAccount, sourceChainData, }) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const query = yield stargate_1.StargateClient.connect(rpc);
        ...
        const signDoc = (0, proto_signing_1.makeSignDoc)(txBodyBytes, authInfoBytes, sourceChainData.chainId, Number(account.base_account.accountNumber));

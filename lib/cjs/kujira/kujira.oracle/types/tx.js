...
class MsgClientImpl {
    ...
    AggregateExchangeRatePrevote(request) {
        ...
        return promise.then((data) => exports.MsgAggregateExchangeRatePrevoteResponse.decode(new minimal_1.Reader(data)));
    }
    AggregateExchangeRateVote(request) {
        ...
        return promise.then((data) => exports.MsgAggregateExchangeRateVoteResponse.decode(new minimal_1.Reader(data)));
    }
    DelegateFeedConsent(request) {
        ...
        return promise.then((data) => exports.MsgDelegateFeedConsentResponse.decode(new minimal_1.Reader(data)));
    }
}

...
exports.Params = {
    ...
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.vote_period = (0, types_1.longToNumber)(reader.uint64());
                    break;
                case 2:
                ...
                case 3:
                    ...
                    break;
                case 4:
                    message.reward_distribution_window = (0, types_1.longToNumber)(reader.uint64());
                    break;
                case 5:
                ...
                case 6:
                    ...
                    break;
                case 7:
                    message.slash_window = (0, types_1.longToNumber)(reader.uint64());
                    break;
                case 8:
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    message.submit_block = (0, types_1.longToNumber)(reader.uint64());
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
...
exports.AggregateExchangeRateVote = {
    ...
    fromJSON(object) {
        ...
        if (object.exchange_rate_tuples !== undefined &&
            ...
            for (const e of object.exchange_rate_tuples) {
                message.exchange_rate_tuples.push(exports.ExchangeRateTuple.fromJSON(e));
            }
        }
        if (object.voter !== undefined && object.voter !== null) {
            message.voter = String(object.voter);
    ...
    toJSON(message) {
        ...
        if (message.exchange_rate_tuples) {
            obj.exchange_rate_tuples = message.exchange_rate_tuples.map((e) => e ? exports.ExchangeRateTuple.toJSON(e) : undefined);
        }
        else {
    ...
    fromPartial(object) {
        ...
        if (object.exchange_rate_tuples !== undefined &&
            object.exchange_rate_tuples !== null) {
            for (const e of object.exchange_rate_tuples) {
                message.exchange_rate_tuples.push(exports.ExchangeRateTuple.fromPartial(e));
            }
        }
        if (object.voter !== undefined && object.voter !== null) {
            message.voter = object.voter;

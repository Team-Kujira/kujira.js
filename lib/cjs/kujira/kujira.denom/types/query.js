...
class QueryClientImpl {
    ...
    DenomAuthorityMetadata(request) {
        ...
        return promise.then((data) => exports.QueryDenomAuthorityMetadataResponse.decode(new minimal_1.Reader(data)));
    }
    DenomsFromCreator(request) {
        ...
        return promise.then((data) => exports.QueryDenomsFromCreatorResponse.decode(new minimal_1.Reader(data)));
    }
}

...
class QueryClientImpl {
    ...
    Hook(request) {
        ...
        return promise.then((data) => exports.QueryGetHookResponse.decode(new binary_1.BinaryReader(data)));
    }
    HookAll(request) {
        ...
        return promise.then((data) => exports.QueryAllHookResponse.decode(new binary_1.BinaryReader(data)));
    }
}

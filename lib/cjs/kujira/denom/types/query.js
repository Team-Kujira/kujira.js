...
class QueryClientImpl {
    ...
    Params(request) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return exports.QueryParamsResponse.decode(new binary_1.BinaryReader(data_1));
        });
    }
    DenomAuthorityMetadata(request) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const data_1 = yield promise;
            return exports.QueryDenomAuthorityMetadataResponse.decode(new binary_1.BinaryReader(data_1));
        });
    }
    DenomsFromCreator(request) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const data_1 = yield promise;
            return exports.QueryDenomsFromCreatorResponse.decode(new binary_1.BinaryReader(data_1));
        });
    }
}

...
exports.Params = {
    ...
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.vote_period = reader.uint64().toNumber();
                    break;
                case 2:
                ...
                case 3:
                    ...
                    break;
                case 4:
                    message.reward_distribution_window = reader.uint64().toNumber();
                    break;
                case 5:
                ...
                case 6:
                    ...
                    break;
                case 7:
                    message.slash_window = reader.uint64().toNumber();
                    break;
                case 8:
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    message.submit_block = reader.uint64().toNumber();
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;

...
class QueryClientImpl {
    ...
    ExchangeRate(request) {
        ...
        return promise.then((data) => exports.QueryExchangeRateResponse.decode(new binary_1.BinaryReader(data)));
    }
    ExchangeRates(request) {
        ...
        return promise.then((data) => exports.QueryExchangeRatesResponse.decode(new binary_1.BinaryReader(data)));
    }
    Actives(request) {
        ...
        return promise.then((data) => exports.QueryActivesResponse.decode(new binary_1.BinaryReader(data)));
    }
    FeederDelegation(request) {
        ...
        return promise.then((data) => exports.QueryFeederDelegationResponse.decode(new binary_1.BinaryReader(data)));
    }
    MissCounter(request) {
        ...
        return promise.then((data) => exports.QueryMissCounterResponse.decode(new binary_1.BinaryReader(data)));
    }
    AggregatePrevote(request) {
        ...
        return promise.then((data) => exports.QueryAggregatePrevoteResponse.decode(new binary_1.BinaryReader(data)));
    }
    AggregatePrevotes(request) {
        ...
        return promise.then((data) => exports.QueryAggregatePrevotesResponse.decode(new binary_1.BinaryReader(data)));
    }
    AggregateVote(request) {
        ...
        return promise.then((data) => exports.QueryAggregateVoteResponse.decode(new binary_1.BinaryReader(data)));
    }
    AggregateVotes(request) {
        ...
        return promise.then((data) => exports.QueryAggregateVotesResponse.decode(new binary_1.BinaryReader(data)));
    }
    Params(request) {

...
class MsgClientImpl {
    ...
    WithdrawAllDelegatorRewards(request) {
        ...
        return promise.then((data) => exports.MsgWithdrawAllDelegatorRewardsResponse.decode(new minimal_1.Reader(data)));
    }
    BatchResetDelegation(request) {
        ...
        return promise.then((data) => exports.MsgBatchResetDelegationResponse.decode(new minimal_1.Reader(data)));
    }
}

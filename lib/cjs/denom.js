...
class Denom {
    constructor(reference, underlying) {
        ...
        this.decimals = 6;
        // wormhole
        if (((_a = this.trace) === null || _a === void 0 ? void 0 : _a.path) === `transfer/channel-113`) {
            this.decimals =
                ((_c = (_b = wormholeAssets
                    .find((a) => { var _a; return a.base === ((_a = this.trace) === null || _a === void 0 ? void 0 : _a.base_denom); })) === null || _b === void 0 ? void 0 : _b.denom_units.at(-1)) === null || _c === void 0 ? void 0 : _c.exponent) || this.decimals;
        }
        if ((((_d = this.trace) === null || _d === void 0 ? void 0 : _d.base_denom) || this.reference).startsWith("erc20/"))
            this.decimals = 18;
        if ((((_e = this.trace) === null || _e === void 0 ? void 0 : _e.base_denom) || this.reference).endsWith("wei"))
            this.decimals = 18;
        if ((((_f = this.trace) === null || _f === void 0 ? void 0 : _f.base_denom) || this.reference).endsWith("-satoshi"))
            this.decimals = 8;
        ...
        if (this.symbol === "DYDX")
            this.decimals = 18;
        if (((_g = this.underlying) === null || _g === void 0 ? void 0 : _g.length) === 2 &&
        ...
        if (((_h = this.underlying) === null || _h === void 0 ? void 0 : _h.length) === 1 && this.decimals === 6)
            this.decimals = this.underlying[0].decimals;
    ...
    static from(string) {
        ...
        const osmosisUnderlying = (_d = (_c = osmosis_json_1.default
            .find((x) => `gamm/pool/${x.id}` === string)) === null || _c === void 0 ? void 0 : _c.assets) === null || _d === void 0 ? void 0 : _d.map((x) => Denom.from(x.token.denom));

...
const labels = {
    ...
    "factory/wormhole14ejqjyq8um4p3xfqj74yld5waqljf88fz25yxnma0cngspxe3les00fpjx/5ZLmAZpcbaP4EGyihSmpfwryzDr84h51tboV392BCjW4": "whUSDC",
};
const terra = {
    uaud: "AUT",
    ucad: "CAT",
...
class Denom {
    constructor(reference, underlying) {
        ...
        this.decimals = 6;
        if ((((_a = this.trace) === null || _a === void 0 ? void 0 : _a.base_denom) || this.reference).startsWith("erc20/"))
            this.decimals = 18;
        ...
        if (this.symbol === "RIO")
            this.decimals = 18;
        if (((_d = this.underlying) === null || _d === void 0 ? void 0 : _d.length) === 2 &&
        ...
        if (((_e = this.underlying) === null || _e === void 0 ? void 0 : _e.length) === 1 && this.decimals === 6)
            this.decimals = this.underlying[0].decimals;

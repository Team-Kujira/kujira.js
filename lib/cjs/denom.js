...
const labels = Object.assign({ ulp: "LP ", wei: "OKT", ugraviton: "GRAV", usdt: "USDT", usat: "nBTC", uregen: "REGEN", 
    ...
    // Old testnet qcKUJI
    "factory/kujira1jaf8tsgvchqfmycv8wmncv52t4fcv3ehuh57gsd9ycce5ewn87ksnwhlkr/urcpt": "qcKUJI", "factory/kujira1eqqr3ad0lh84ua4m5qu2n4jjz6h73d64jfwvng0w2k0lnhltt4jqdex4z9/urcpt": "qcKUJI", "factory/kujira1l04ged98c7a7s9tllu62ld09ztylwf442qgm4thfgmadrvngeumsz4zrh2/urcpt": "qcFUZN", "factory/migaloo1eqntnl6tzcj9h86psg4y4h6hh05g2h9nj8e09l/urac": "RAC", "factory/osmo1mlng7pz4pnyxtpq0akfwall37czyk9lukaucsrn30ameplhhshtqdvfm5c/ulvn": "LVN", "factory/osmo1z0qrq605sjgcqpylfl4aa6s90x738j7m58wyatt0tdzflg2ha26q67k743/wbtc": "wBTC", gravity0x45804880De22913dAFE09f4980848ECE6EcbAf78: "gPAXG", gravity0xfB5c6815cA3AC72Ce9F5006869AE67f18bF77006: "gPSTAKE", gravity0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2: "gwETH", gravity0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48: "gUSDC", gravity0xdAC17F958D2ee523a2206206994597C13D831ec7: "gUSDT", gravity0x2260FAC5E5542a773Aa44fBCfeDf7C193bc2C599: "gwBTC", gravity0x6B175474E89094C44Da98b954EedeAC495271d0F: "gDAI", gravity0x77E06c9eCCf2E797fd462A92B6D7642EF85b0A44: "wTAO", gravity0xa0b93B9e90aB887E53F9FB8728c009746e989B53: "gTST", gravity0xe28b3B32B6c345A34Ff64674606124Dd5Aceca30: "gINJ", gravity0xB50721BCf8d664c30412Cfbc6cf7a15145234ad1: "gARB", gravity0x4c11249814f11b9346808179Cf06e71ac328c1b5: "gORAI", gravity0x93581991f68DBaE1eA105233b67f7FA0D6BDeE7b: "gwEVMOS", gravity0x35a532d376FFd9a705d0Bb319532837337A398E7: "gwDOGE", gravity0x07baC35846e5eD502aA91AdF6A9e7aA210F2DcbE: "gerowan", gravity0xd2877702675e6cEb975b4A1dFf9fb7BAF4C91ea9: "gwLUNC", gravity0x95aD61b0a150d79219dCF64E1E6Cc01f0B64C4cE: "gSHIB", 
    // 18
...
class Denom {
    constructor(reference, underlying) {
        ...
        if (this.reference.startsWith("ibc/")) {
            ...
            if (((_a = this.trace) === null || _a === void 0 ? void 0 : _a.path) === "transfer/channel-9") {
                this.symbol = "axl";
            }
        }
        this.symbol += baseDenomToSymbol(this.reference);
        if ((_b = this.trace) === null || _b === void 0 ? void 0 : _b.base_denom.startsWith("gamm")) {
        ...
        this.decimals = 6;
        // wormhole
        if (((_c = this.trace) === null || _c === void 0 ? void 0 : _c.path) === `transfer/channel-113`) {
            this.decimals =
                ((_e = (_d = wormholeAssets
                    .find((a) => { var _a; return a.base === ((_a = this.trace) === null || _a === void 0 ? void 0 : _a.base_denom); })) === null || _d === void 0 ? void 0 : _d.denom_units.at(-1)) === null || _e === void 0 ? void 0 : _e.exponent) || this.decimals;
        }
        if ((((_f = this.trace) === null || _f === void 0 ? void 0 : _f.base_denom) || this.reference).startsWith("erc20/"))
            this.decimals = 18;
        if ((((_g = this.trace) === null || _g === void 0 ? void 0 : _g.base_denom) || this.reference).startsWith("gravity"))
            this.decimals = 18;
        if ((((_h = this.trace) === null || _h === void 0 ? void 0 : _h.base_denom) || this.reference).endsWith("wei"))
            this.decimals = 18;
        if ((((_j = this.trace) === null || _j === void 0 ? void 0 : _j.base_denom) || this.reference).endsWith("-satoshi"))
            this.decimals = 8;
        ...
        if (this.symbol === "CHEQ")
            this.decimals = 9;
        if (((_k = this.underlying) === null || _k === void 0 ? void 0 : _k.length) === 2 &&
        ...
        if (((_l = this.underlying) === null || _l === void 0 ? void 0 : _l.length) === 1 && this.decimals === 6)
            this.decimals = this.underlying[0].decimals;

...
class Denom {
    constructor(reference, underlying) {
        ...
        if ((((_e = this.trace) === null || _e === void 0 ? void 0 : _e.base_denom) || this.reference).startsWith("erc20/"))
            this.decimals = 18;
        if ((((_f = this.trace) === null || _f === void 0 ? void 0 : _f.base_denom) || this.reference).endsWith("wei"))
            this.decimals = 18;
        if ((((_g = this.trace) === null || _g === void 0 ? void 0 : _g.base_denom) || this.reference).endsWith("-satoshi"))
            this.decimals = 8;
        ...
        if (this.symbol === "DYDX")
            this.decimals = 18;
        if (((_h = this.underlying) === null || _h === void 0 ? void 0 : _h.length) === 2 &&
        ...
        if (((_j = this.underlying) === null || _j === void 0 ? void 0 : _j.length) === 1 && this.decimals === 6)
            this.decimals = this.underlying[0].decimals;

...
const rates_1 = require("./ghost/rates");
...
const castVault = (address, raw, markets) => ({
    ...
    utilizationRates: (rates_1.rates[address] || rates_1.RATE_DEFAULT).map(([a, b]) => [
...
exports.VAULTS = {
    [network_1.MAINNET]: contracts_json_1.default[network_1.MAINNET].ghostVault.reduce((a, v) => (Object.assign(Object.assign({}, a), { [v.address]: (0, exports.castVault)(v.address, v.config, v.markets || []) })), {}),
    [network_1.TESTNET]: contracts_json_1.default[network_1.TESTNET].ghostVault.reduce((a, v) => (Object.assign(Object.assign({}, a), { [v.address]: (0, exports.castVault)(v.address, v.config, v.markets || []) })), {}),
    [network_1.LOCALNET]: {},
};
exports.MARKETS = {
    [network_1.MAINNET]: contracts_json_1.default[network_1.MAINNET].ghostMarket.reduce((a, v) => exports.VAULTS[network_1.MAINNET][v.config.vault_addr]

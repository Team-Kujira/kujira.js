...
exports.Tx = {
    ...
    fromJSON(object) {
        ...
        if (object.signatures !== undefined && object.signatures !== null) {
            for (const e of object.signatures) {
                message.signatures.push((0, types_1.bytesFromBase64)(e));
            }
        }
        return message;
    },
    toJSON(message) {
        ...
        if (message.signatures) {
            obj.signatures = message.signatures.map((e) => (0, types_1.base64FromBytes)(e !== undefined ? e : new Uint8Array()));
        }
        else {
            obj.signatures = [];
        }
...
exports.TxRaw = {
    ...
    fromJSON(object) {
        ...
        if (object.body_bytes !== undefined && object.body_bytes !== null) {
            message.body_bytes = (0, types_1.bytesFromBase64)(object.body_bytes);
        }
        if (object.auth_info_bytes !== undefined &&
            object.auth_info_bytes !== null) {
            message.auth_info_bytes = (0, types_1.bytesFromBase64)(object.auth_info_bytes);
        }
        if (object.signatures !== undefined && object.signatures !== null) {
            for (const e of object.signatures) {
                message.signatures.push((0, types_1.bytesFromBase64)(e));
    ...
    toJSON(message) {
        ...
        message.body_bytes !== undefined &&
            (obj.body_bytes = (0, types_1.base64FromBytes)(message.body_bytes !== undefined ? message.body_bytes : new Uint8Array()));
        message.auth_info_bytes !== undefined &&
            (obj.auth_info_bytes = (0, types_1.base64FromBytes)(message.auth_info_bytes !== undefined
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    ...
                    break;
                case 2:
                    message.gas_limit = (0, types_1.longToNumber)(reader.uint64());
                    break;
                case 3:

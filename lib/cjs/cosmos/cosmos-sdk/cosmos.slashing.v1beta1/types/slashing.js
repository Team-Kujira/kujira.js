...
exports.ValidatorSigningInfo = {
    encode(message, writer = minimal_1.Writer.create()) {
        ...
        if (message.jailed_until !== undefined) {
            timestamp_1.Timestamp.encode((0, types_1.toTimestamp)(message.jailed_until), writer.uint32(34).fork()).ldelim();
        }
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    ...
                    break;
                case 2:
                    message.start_height = (0, types_1.longToNumber)(reader.int64());
                    break;
                case 3:
                    message.index_offset = (0, types_1.longToNumber)(reader.int64());
                    break;
                case 4:
                    message.jailed_until = (0, types_1.fromTimestamp)(timestamp_1.Timestamp.decode(reader, reader.uint32()));
                    break;
                case 5:
                    message.tombstoned = reader.bool();
                    break;
                case 6:
                    message.missed_blocks_counter = (0, types_1.longToNumber)(reader.int64());
                    break;
                default:
    ...
    fromJSON(object) {
        ...
        if (object.jailed_until !== undefined && object.jailed_until !== null) {
            message.jailed_until = (0, types_1.fromJsonTimestamp)(object.jailed_until);
        }
        else {
...
exports.Params = {
    ...
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.signed_blocks_window = (0, types_1.longToNumber)(reader.int64());
                    break;
                case 2:
    ...
    fromJSON(object) {
        ...
        if (object.min_signed_per_window !== undefined &&
            ...
            message.min_signed_per_window = (0, types_1.bytesFromBase64)(object.min_signed_per_window);
        }
        ...
        if (object.slash_fraction_double_sign !== undefined &&
            ...
            message.slash_fraction_double_sign = (0, types_1.bytesFromBase64)(object.slash_fraction_double_sign);
        }
        if (object.slash_fraction_downtime !== undefined &&
            object.slash_fraction_downtime !== null) {
            message.slash_fraction_downtime = (0, types_1.bytesFromBase64)(object.slash_fraction_downtime);
        }
        return message;
    },
    toJSON(message) {
        ...
        message.min_signed_per_window !== undefined &&
            (obj.min_signed_per_window = (0, types_1.base64FromBytes)(message.min_signed_per_window !== undefined
        ...
        message.slash_fraction_double_sign !== undefined &&
            (obj.slash_fraction_double_sign = (0, types_1.base64FromBytes)(message.slash_fraction_double_sign !== undefined
                ? message.slash_fraction_double_sign
                : new Uint8Array()));
        message.slash_fraction_downtime !== undefined &&
            (obj.slash_fraction_downtime = (0, types_1.base64FromBytes)(message.slash_fraction_downtime !== undefined

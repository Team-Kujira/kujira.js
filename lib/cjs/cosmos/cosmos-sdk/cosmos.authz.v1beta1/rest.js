...
class Api extends HttpClient {
    constructor() {
         ...
         */
        this.queryGrants = (query, params = {}) => this.request(Object.assign({ path: `/cosmos/authz/v1beta1/grants`, method: "GET", query: query, format: "json" }, params));
        /**
         ...
         */
        this.queryGranteeGrants = (grantee, query, params = {}) => this.request(Object.assign({ path: `/cosmos/authz/v1beta1/grants/grantee/${grantee}`, method: "GET", query: query, format: "json" }, params));
        /**
         * @description Since: cosmos-sdk 0.45.2
         *
         * @tags Query
         ...
         */
        this.queryGranterGrants = (granter, query, params = {}) => this.request(Object.assign({ path: `/cosmos/authz/v1beta1/grants/granter/${granter}`, method: "GET", query: query, format: "json" }, params));
    }
}
exports.Api = Api;

...
class Api extends HttpClient {
    constructor() {
       ...
       */
        this.querySpendableBalances = (address, query, params = {}) => this.request(Object.assign({ path: `/cosmos/bank/v1beta1/spendable_balances/${address}`, method: "GET", query: query, format: "json" }, params));
        /**
         * No description
         *
         * @tags Query

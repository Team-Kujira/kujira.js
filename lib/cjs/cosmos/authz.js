        ...
        "/cosmos.authz.v1beta1.MsgGrant": {
                ...
                return ({
                    ...
                    grant: {
                        authorization: {
                            ...
                            value: (((_a = grant === null || grant === void 0 ? void 0 : grant.authorization) === null || _a === void 0 ? void 0 : _a.value) &&
            ...
            fromAmino: ({ granter, grantee, grant }) => tx_1.MsgGrant.fromPartial({
                ...
                grant: {
                    authorization: {
                        typeUrl: "/cosmos.authz.v1beta1.GenericAuthorization",
                        value: authz_1.GenericAuthorization.encode(authz_1.GenericAuthorization.decode(Buffer.from(grant.authorization.value, "base64"))).finish(),
                    },

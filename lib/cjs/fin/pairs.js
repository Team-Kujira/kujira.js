...
const compile = (network) => (a, v) => {
    ...
    return Object.assign(Object.assign({}, a), { [v.address]: Object.assign(Object.assign({ address: v.address }, config), { pool: (_a = contracts_json_1.default[network].bow.find((b) => b.config.fin_contract === v.address)) === null || _a === void 0 ? void 0 : _a.address, calc: contracts_json_1.default[network].calc[0].pairs.find((x) => x.base_denom === config.denoms[0].reference &&
                x.quote_denom === config.denoms[1].reference)
                ? contracts_json_1.default[network].calc[0].address

...
exports.fetchPositionsLimit = exports.fetchPositionLimit = exports.fetchPositionMarket = exports.defaultPositionMarket = void 0;
...
const castPositionLimit = (denoms) => (p) => ({
    idx: p.idx,
    owner: p.owner,
    margin_amount: bignumber_1.BigNumber.from(p.margin_amount),

...
const tx_6 = require("cosmjs-types/ibc/core/client/v1/tx");
...
exports.msg = {
    ...
    wasm: {
        msgClearAdmin: (i) => ({
            ...
            value: tx_4.MsgClearAdmin.fromPartial(i),
        }),
        ...
        msgStoreCode: (i) => ({
            ...
            value: tx_4.MsgStoreCode.fromPartial(i),
        }),
    ...
    ibc: {
        ...
        msgUpdateClient: (i) => ({
            ...
            value: tx_6.MsgUpdateClient.fromPartial(i),
        }),
    },
    gravity: gravity.msg,
    batch: batch.msg,

...
class Api extends HttpClient {
    constructor() {
         ...
         */
        this.queryBaseFee = (params = {}) => this.request(Object.assign({ path: `/ethermint/feemarket/v1/base_fee`, method: "GET", format: "json" }, params));
        /**
         * No description
         *
         * @tags Query
         ...
         */
        this.queryBlockGas = (params = {}) => this.request(Object.assign({ path: `/ethermint/feemarket/v1/block_gas`, method: "GET", format: "json" }, params));
        /**
         * No description
         *
         * @tags Query
         ...
         */
        this.queryParams = (params = {}) => this.request(Object.assign({ path: `/ethermint/feemarket/v1/params`, method: "GET", format: "json" }, params));
    }
}
exports.Api = Api;

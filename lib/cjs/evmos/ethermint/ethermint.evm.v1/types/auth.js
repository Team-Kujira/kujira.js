...
exports.EthAccount = {
    encode(message, writer = minimal_1.Writer.create()) {
        if (message.base_account !== undefined) {
            exports.EthAccount.encode(message.base_account, writer.uint32(10).fork()).ldelim();
        }
    ...
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.base_account = exports.EthAccount.decode(reader, reader.uint32());
                    break;
                case 2:
    ...
    fromJSON(object) {
        ...
        if (object.base_account !== undefined && object.base_account !== null) {
            message.base_account = exports.EthAccount.fromJSON(object.base_account);
        }
        else {
    ...
    toJSON(message) {
        ...
        message.base_account !== undefined &&
            (obj.base_account = message.base_account
                ? exports.EthAccount.toJSON(message.base_account)
                : undefined);
    ...
    fromPartial(object) {
        const message = Object.assign({}, baseEthAccount);
        if (object.base_account !== undefined && object.base_account !== null) {
            message.base_account = exports.EthAccount.fromPartial(object.base_account);
        }
        else {
            message.base_account = undefined;
        }

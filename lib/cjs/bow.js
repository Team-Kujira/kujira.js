...
exports.POOLS = {
    [network_1.MAINNET]: contracts_json_1.default[network_1.MAINNET].bow.reduce((a, v) => (Object.assign(Object.assign({}, a), { [v.address]: (0, exports.castPool)(v.config) })), {}),
    [network_1.TESTNET]: contracts_json_1.default[network_1.TESTNET].bow.reduce((a, v) => (Object.assign(Object.assign({}, a), { [v.address]: (0, exports.castPool)(v.config) })), {}),
    [network_1.LOCALNET]: {},
};

...
export declare const wETH: Denom;
export declare const wMATIC: Denom;
export declare const wBNB: Denom;
export declare const wAVAX: Denom;
export declare const wGLMR: Denom;
export declare const wFTM: Denom;

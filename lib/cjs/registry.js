...
const tx_1 = require("cosmjs-types/cosmos/upgrade/v1beta1/tx");
const upgrade_1 = require("cosmjs-types/cosmos/upgrade/v1beta1/upgrade");
const tx_2 = require("@injectivelabs/core-proto-ts/cjs/cosmos/gov/v1/tx");
const tx_3 = require("@injectivelabs/core-proto-ts/cjs/cosmwasm/wasm/v1/tx");
const tx_4 = require("cosmjs-types/cosmos/bank/v1beta1/tx");
const tx_5 = require("cosmjs-types/cosmos/distribution/v1beta1/tx");
...
const proposalTypes = [
    ...
    ["/cosmos.params.v1beta1.MsgUpdateParams", tx_4.MsgUpdateParams],
    ...
    ["/cosmwasm.wasm.v1.MsgPinCodes", tx_3.MsgPinCodes],
    ["/cosmwasm.wasm.v1.MsgUnpinCodes", tx_3.MsgUnpinCodes],

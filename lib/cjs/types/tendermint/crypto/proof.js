...
exports.Proof = {
    ...
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.total = (0, __1.longToNumber)(reader.int64());
                    break;
                case 2:
    ...
    fromJSON(object) {
        ...
        if (object.leaf_hash !== undefined && object.leaf_hash !== null) {
            message.leaf_hash = (0, __1.bytesFromBase64)(object.leaf_hash);
        }
        if (object.aunts !== undefined && object.aunts !== null) {
            for (const e of object.aunts) {
                message.aunts.push((0, __1.bytesFromBase64)(e));
            }
        }
        return message;
    },
    toJSON(message) {
        ...
        message.leaf_hash !== undefined &&
            (obj.leaf_hash = (0, __1.base64FromBytes)(message.leaf_hash !== undefined ? message.leaf_hash : new Uint8Array()));
        if (message.aunts) {
            obj.aunts = message.aunts.map((e) => (0, __1.base64FromBytes)(e !== undefined ? e : new Uint8Array()));
        }
        else {
            obj.aunts = [];
        }

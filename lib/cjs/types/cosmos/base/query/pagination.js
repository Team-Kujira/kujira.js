        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    ...
                    break;
                case 2:
                    message.offset = (0, __1.longToNumber)(reader.uint64());
                    break;
                case 3:
...
exports.PageResponse = {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    ...
                    break;
                case 2:
                    message.total = (0, __1.longToNumber)(reader.uint64());
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON(object) {
        ...
        if (object.next_key !== undefined && object.next_key !== null) {
            message.next_key = (0, __1.bytesFromBase64)(object.next_key);
        }
    ...
    toJSON(message) {
        ...
        message.next_key !== undefined &&
            (obj.next_key = (0, __1.base64FromBytes)(message.next_key !== undefined ? message.next_key : new Uint8Array()));

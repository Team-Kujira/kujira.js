...
export declare const QueryDenomAuthorityMetadataRequest: {
    ...
    decode(input: Reader | Uint8Array, length?: number | undefined): QueryDenomAuthorityMetadataRequest;
...
export declare const QueryDenomAuthorityMetadataResponse: {
    ...
    decode(input: Reader | Uint8Array, length?: number | undefined): QueryDenomAuthorityMetadataResponse;
...
export declare const QueryDenomsFromCreatorRequest: {
    ...
    decode(input: Reader | Uint8Array, length?: number | undefined): QueryDenomsFromCreatorRequest;
...
export declare const QueryDenomsFromCreatorResponse: {
    ...
    decode(input: Reader | Uint8Array, length?: number | undefined): QueryDenomsFromCreatorResponse;

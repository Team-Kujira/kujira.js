...
export class Api extends HttpClient {
    constructor() {
         ...
         */
        this.queryDenomsFromCreator = (creator, params = {}) => this.request(Object.assign({ path: `/kujira/denoms/by_creator/${creator}`, method: "GET", format: "json" }, params));
        /**
         * No description
         *
         * @tags Query
         ...
         */
        this.queryParams = (params = {}) => this.request(Object.assign({ path: `/kujira/denoms/params`, method: "GET", format: "json" }, params));
        /**
         * No description
         *
         * @tags Query
         ...
         */
        this.queryDenomAuthorityMetadata = (denom, params = {}) => this.request(Object.assign({ path: `/kujira/denoms/${denom}/authority_metadata`, method: "GET", format: "json" }, params));
    }
}

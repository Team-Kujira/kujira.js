...
export declare const MsgGrant: {
    ...
    decode(input: Reader | Uint8Array, length?: number | undefined): MsgGrant;
...
export declare const MsgExecResponse: {
    ...
    decode(input: Reader | Uint8Array, length?: number | undefined): MsgExecResponse;
...
export declare const MsgExec: {
    ...
    decode(input: Reader | Uint8Array, length?: number | undefined): MsgExec;
...
export declare const MsgGrantResponse: {
    ...
    decode(input: Reader | Uint8Array, length?: number | undefined): MsgGrantResponse;
...
export declare const MsgRevoke: {
    ...
    decode(input: Reader | Uint8Array, length?: number | undefined): MsgRevoke;
...
export declare const MsgRevokeResponse: {
    ...
    decode(input: Reader | Uint8Array, length?: number | undefined): MsgRevokeResponse;

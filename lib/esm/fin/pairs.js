...
const compile = (network) => (a, v) => {
    ...
    return Object.assign(Object.assign({}, a), { [v.address]: Object.assign(Object.assign({ address: v.address }, config), { pool: (_a = contracts[network].bow
                ...
                v.config.price_precision.decimal_places ===
                    b.config.price_precision.decimal_places)) === null || _a === void 0 ? void 0 : _a.address, calc: ((_b = contracts[network].calc[0]) === null || _b === void 0 ? void 0 : _b.pairs.find((x) => x.base_denom === config.denoms[0].reference &&

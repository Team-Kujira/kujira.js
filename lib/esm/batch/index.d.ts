...
declare const types: ((string | {
    typeUrl: string;
    encode(message: MsgWithdrawAllDelegatorRewards, writer?: import("protobufjs").Writer): import("protobufjs").Writer;
    decode(input: import("protobufjs").Reader | Uint8Array, length?: number | undefined): MsgWithdrawAllDelegatorRewards;
    ...
    typeUrl: string;
    encode(message: MsgBatchResetDelegation, writer?: import("protobufjs").Writer): import("protobufjs").Writer;
    decode(input: import("protobufjs").Reader | Uint8Array, length?: number | undefined): MsgBatchResetDelegation;

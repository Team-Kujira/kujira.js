...
export const VAULTS = {
    [MAINNET]: contracts[MAINNET].ghostVault.reduce((a, v) => (Object.assign(Object.assign({}, a), { [v.address]: castVault(v.address, v.config, v.markets || []) })), {}),
    [TESTNET]: contracts[TESTNET].ghostVault.reduce((a, v) => (Object.assign(Object.assign({}, a), { [v.address]: castVault(v.address, v.config, v.markets || []) })), {}),
    [LOCALNET]: {},
};
export const MARKETS = {
    [MAINNET]: contracts[MAINNET].ghostMarket.reduce((a, v) => VAULTS[MAINNET][v.config.vault_addr]

...
export class Denom {
    constructor(reference, underlying) {
        ...
        this.symbol = baseDenomToSymbol(((_a = this.trace) === null || _a === void 0 ? void 0 : _a.base_denom) || this.reference);
        if (this.underlying) {
        ...
        this.decimals = 6;
        if ((((_b = this.trace) === null || _b === void 0 ? void 0 : _b.base_denom) || this.reference).endsWith("wei"))
            this.decimals = 18;
        if ((((_c = this.trace) === null || _c === void 0 ? void 0 : _c.base_denom) || this.reference).endsWith("-satoshi"))
            this.decimals = 8;

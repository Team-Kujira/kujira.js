...
export const POOLS = {
    [MAINNET]: contracts[MAINNET].bow.reduce((a, v) => (Object.assign(Object.assign({}, a), { [v.address]: castPool(v.config) })), {}),
    [TESTNET]: contracts[TESTNET].bow.reduce((a, v) => (Object.assign(Object.assign({}, a), { [v.address]: castPool(v.config) })), {}),
    [LOCALNET]: {},
};

...
export const EXCLUDED = [
    ...
    "kujira120qrsyprtjpxanym4fx0n37t8wym5t4emclxnyl3tyn9at62xppsd9ll2j",
];
...
export const POOLS = {
    [MAINNET]: contracts[MAINNET].bow.reduce((a, v) => EXCLUDED.includes(v.address)
        ? a
        : Object.assign(Object.assign({}, a), { [v.address]: castPool(v.address, v.config, Object.values(contracts[MAINNET].bowMargin).find((x) => x.config.bow_contract === v.address)) }), {}),
